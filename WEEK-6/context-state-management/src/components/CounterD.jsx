...
function CounterD() {
  ...
  return (
    <div>
        <h1 className="text-4xl text-center mb-2">Counter D</h1>
        <div className="bg-orange-400 mx-10 p-12 text-center">
            ...
            <button onClick={decrementCounter} className="bg-red-500 border border-red-700 text-3xl w-12 h-12">-</button>
        </div>
    </div>
  )
}
